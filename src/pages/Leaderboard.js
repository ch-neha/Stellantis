    ...
    return (
        ...
        <div className="container" style={{ width:"50%", justifyContent: "center" }}>
            ...
            <div className="duration d-flex justify-content-center">
                <button type="button" class="btn btn-danger m-1" onClick={handleClick} >League 1</button>
                <button type="button" class="btn btn-danger m-1" onClick={handleClick2} >League 2</button>
                <button type="button" class="btn btn-danger m-1" onClick={handleClick3} >League 3</button>
            </div>
...

            {
                data.map((value, index) => (
                    ...
                    <tr>
                    <td>{index+1}</td>
                    <td><img src={value.img} width="75"  alt="" /></td>
                    <td><h5 className='name text-dark' >{value.name}</h5></td>
                    <td><h>{value.score}</h></td>
                    <td>{value.streak}🔥</td>
                    </tr>
